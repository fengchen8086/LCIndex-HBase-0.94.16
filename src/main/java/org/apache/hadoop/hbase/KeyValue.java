...
public class KeyValue implements Writable, HeapSize, Cloneable {
  ...
  public String mWinterGetKeyString(){
    return mWinterInnerGetKeyString(this.bytes, this.offset + ROW_OFFSET, getKeyLength());
  }
  
  private static String mWinterInnerGetKeyString(final byte [] b, final int o, final int l) {
    if (b == null) return "";
    int rowlength = Bytes.toShort(b, o);
    String row = Bytes.toStringBinary(b, o + Bytes.SIZEOF_SHORT, rowlength);
    return row;
