 ...
 */
public class KeyValueHeap extends NonLazyKeyValueScanner implements KeyValueScanner,
    InternalScanner {
  ...
  public KeyValue peek() {
    ...
    // if (this.current instanceof MemStoreScanner) {
    // System.out.println("winter now scanning MemStoreScanner, peek value: "
    // + LCCIndexGenerator.mWinterToPrint(this.current.peek()));
    // }
   ...
   * <p>
   * This function (and {@link #reseek(KeyValue)}) does not do multi-column Bloom filter and
   * lazy-seek optimizations. To enable those, call {@link #requestSeek(KeyValue, boolean, boolean)}.
  ...
  /**
   * This function is identical to the {@link #seek(KeyValue)} function except that
   ...
   */
  private boolean generalizedSeek(boolean isLazy, KeyValue seekKey, boolean forward,
