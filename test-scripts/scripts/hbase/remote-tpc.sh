...
fun_RunInsertData(){
	fun_TestPut $1 $2 $forceflush $generatedDataDir $3 $4 $5
}
...
fun_GenerateData $maxRecordNumber $tpchFilePath $generatedDataDir $statFileName $clientFile $threadNumber false
